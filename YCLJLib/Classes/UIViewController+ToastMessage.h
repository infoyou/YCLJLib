...
typedef void(^ATMHudCompletionBlock)(void);
...
//call back block
- (ATMHud *)showHUDWithText:(NSString *)text methodBlock:(void(^)(ATMHudCompletionBlock completionBlock, ATMHud *hud))methodBlock;
- (ATMHud *)showHUDWithText:(NSString *)text methodBlock:(void(^)(ATMHudCompletionBlock completionBlock, ATMHud *hud))methodBlock completion:(void (^)())completion;
- (ATMHud *)showHUDWithText:(NSString *)text inView:(UIView *)view methodBlock:(void(^)(ATMHudCompletionBlock completionBlock, ATMHud *hud))methodBlock ;
- (ATMHud *)showHUDWithText:(NSString *)text inView:(UIView *)view methodBlock:(void(^)(ATMHudCompletionBlock completionBlock, ATMHud *hud))methodBlock completion:(void (^)(void))completion;

- (ATMHud *)showHUDWithText:(NSString *)text inView:(UIView *)view hudType:(ALHUDType)type methodBlock:(void(^)(ATMHudCompletionBlock completionBlock, ATMHud *hud))methodBlock completion:(void (^)(void))completion;
...
- (void)updateToastTitle:(ATMHud *)hud title:(NSString *)title completionBlock:(ATMHudCompletionBlock )completionBlock afterDelay:(float)afterDelay;
- (void)updateToast:(ATMHud *)hud title:(NSString *)title hudType:(ALHUDType)type completionBlock:(ATMHudCompletionBlock )completionBlock afterDelay:(float)afterDelay;
